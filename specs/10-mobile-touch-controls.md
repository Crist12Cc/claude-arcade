...
> **Estado:** Propuesto
>
> **Nota (2026-09-13):** este archivo estaba marcado como "implementado" pero nunca se
> construyó (`components/MobileGamepad.tsx` no existe, ningún juego lo usa, y el archivo
> nunca se commiteó). Además asume play-pages por juego (`app/games/<juego>/play/page.tsx`)
> que no existen — el repo real usa la ruta genérica `/jugar/[id]` + `components/GamePlayer.tsx`
> compartido por todos los motores. Hay que re-aprobar esta spec adaptada a esa arquitectura
> antes de retomarla.
